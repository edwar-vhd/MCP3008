...
add wave -noupdate -format analog-step -height 50 -min 0 -max 1024 -label CH4 -color "Aquamarine" -radix decimal	/MCP3008_tb/ch(4)
...
add wave -noupdate -format analog-step -height 50 -min 0 -max 1024 -label Reg_Data_Out -color #FF00FF -radix binary	/MCP3008_tb/d_o_reg